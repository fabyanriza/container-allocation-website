...
export default function ContainerList({ refreshKey }: { refreshKey?: number }) {
  ...
  function applyFilters() {
    ...
    if (selectedDepot !== "all") {
      filtered = filtered.filter(
        (c) => c.depot_id === Number.parseInt(selectedDepot),
      );
    }
  ...
  function handleExportCSV() {
    ...
    exportToCSV(
      exportData,
      `containers_${new Date().toISOString().split("T")[0]}`,
    );
  }
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {container.depots?.name || "Unknown Depot"}
                    </p>
                  </div>
                ...
                <div className="flex gap-2 pt-2 border-t">
                  <Button
                    ...
                    className="flex-1"
                    onClick={() =>
                      openDeleteDialog(container.id, container.container_number)
                    }
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{deleteDialog.containerNumber}</strong>? This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="flex gap-3 justify-end">
            ...
            <AlertDialogAction
              onClick={() =>
                deleteDialog.containerId &&
                handleDeleteContainer(deleteDialog.containerId)
              }
